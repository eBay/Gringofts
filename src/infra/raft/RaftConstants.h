...
struct RaftConstants {
  ...
  static constexpr uint64_t kMinElectionTimeoutInMillis = 2000;
  ...
  static const uint64_t kHeartBeatIntervalInMillis = 100;

  struct AppendEntries { static constexpr uint64_t kRpcTimeoutInMillis = 1000; };
